...
@InputType()
class CarReviewCreateNestedManyWithoutVariantsInput {
...
export { CarReviewCreateNestedManyWithoutVariantsInput as CarReviewCreateNestedManyWithoutVariantsInput };
